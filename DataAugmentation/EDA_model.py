...
for technique in techniques:
    ...
    for avg_t in range(0, tec_len):
        ...
        train_set_arr_augment, label_set_augmented = Augmented_data.augment_data(train_set[0], train_label, technique)
        ...
        # AUGMENTATION
        callback = tf.keras.callbacks.EarlyStopping(monitor='loss', patience=5)
        history = model.fit(train_set_arr_augment, label_set_augmented, epochs=epoch, batch_size=batch_s, shuffle=True,
